...
// Device related
//
const calibration = 0.25; // Magic number based on real world measurements against a ruler
...
const watchHCSR04 = (controller) => {
    ...
    echo.on('alert', (level, tick) => {
        if (level == 1) {
            ...
            let reading = (diff / MICROSECDONDS_PER_CM) * calibration;
            controller.distance = reading;
            controller.currentColor = toColor(controller.distance, zones);
        }
    });
};
